...
namespace LeapInternal {
  ...
  public static class CopyFromLeapCExtensions {
    ...
    public static Finger CopyFrom(this Finger finger, LEAP_DIGIT leapBone, Finger.FingerType type, int handId, float timeVisible) {
      ...
      metacarpal.CopyFrom(leapBone.metacarpal, Bone.BoneType.TYPE_METACARPAL);
      proximal.CopyFrom(leapBone.proximal, Bone.BoneType.TYPE_PROXIMAL);
      intermediate.CopyFrom(leapBone.intermediate, Bone.BoneType.TYPE_INTERMEDIATE);
      distal.CopyFrom(leapBone.distal, Bone.BoneType.TYPE_DISTAL);
