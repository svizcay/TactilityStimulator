...
namespace Leap.Unity {
  ...
  public static class Hands {
    ...
    public static Finger GetThumb(this Hand hand) {
      return hand.Fingers[(int)Finger.FingerType.TYPE_THUMB];
    }
    ...
    public static Finger GetIndex(this Hand hand) {
      return hand.Fingers[(int)Finger.FingerType.TYPE_INDEX];
    }
    ...
    public static Finger GetMiddle(this Hand hand) {
      return hand.Fingers[(int)Finger.FingerType.TYPE_MIDDLE];
    }
    ...
    public static Finger GetRing(this Hand hand) {
      return hand.Fingers[(int)Finger.FingerType.TYPE_RING];
    }
    ...
    public static Finger GetPinky(this Hand hand) {
      return hand.Fingers[(int)Finger.FingerType.TYPE_PINKY];
    }
